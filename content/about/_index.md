+++
title = "About KaiOS.dev"
description = "A blog dedicated to the KaiOS ecosystem"
...
**Cloud Phone**, a remote browser based on [Puffin](https://www.puffin.com/), serves as an app store for budget 4G feature phones that run a real-time operating system (RTOS) like Mocor by Unisoc. Thanks to server-side rendering, Cloud Phone is an easy development target as there is no need for optimizations or costly refactors. With over [100+ devices](https://developer.cloudfone.com/device/), Cloud Phones come in all shapes and sizes but typically sport small QVGA (240x320) or QQVGA (128x160) screens, D-pad navigation, and a T9 keyboard. With about 100 total applications and games, it's easy to get organic traffic and make an impact on the lives of millions.

For corporate consulations, please email tom@barrasso.me to discuss. Except as otherwise noted, the content of this page is licensed under the [Creative Commons Attribution 4.0 License](https://creativecommons.org/licenses/by/4.0/), and code samples are licensed under the [Apache 2.0 License](https://www.apache.org/licenses/LICENSE-2.0). Code samples are provided "as is", without warranty of any kind, express or implied, including but not limited to the warranties of merchantability, fitness for a particular purpose and noninfringement.

This website is open source and available on [GitHub](https://github.com/Tombarr/kaios-dev-blog/).

### Support

If you find this blog valuable, please consider supporting via PayPal or [Buy Me A Coffee](https://buymeacoffee.com/barrasso).

{{< rawhtml >}}
<ul style="list-style-type: none; margin: 0; padding: 0;">
    <li style="height: 21px; margin-bottom: 1rem;">
        <form action="https://www.paypal.com/cgi-bin/webscr" method="post" target="_top">
            <input type="hidden" name="cmd" value="_s-xclick" />
            <input type="hidden" name="hosted_button_id" value="2FKE94UCTCKCJ" />
            <input class="donate-button align-middle py-2 px-4" tabindex="-1" type="image" src="https://www.paypalobjects.com/en_US/i/btn/btn_donate_SM.gif" border="0" name="submit" title="Donate via PayPal" alt="Donate via PayPal" />
            <img alt="" border="0" src="https://www.paypal.com/en_US/i/scr/pixel.gif" width="1" height="1" />
        </form>
    </li>
    <li>
        <a href="https://www.buymeacoffee.com/barrasso" target="_blank" rel="external noopener nofollow" style="display: block;">
            <img src="https://cdn.buymeacoffee.com/buttons/v2/arial-yellow.png" alt="Buy Me A Coffee" loading="lazy" style="cursor: pointer;height: 30px !important;width: 109px !important; margin: 0;" />
        </a>
    </li>
</ul>
{{< /rawhtml >}}
